...
def display_harvest_plan(recipe: dict):
    ...
    console.print(Panel(f"[bold blue]Initializing Sovereign Knowledge Harvester[/bold blue]\nTarget: [green]{title}[/green] ({domain})", expand=False))
...
def main():
    ...
    if args.action == "run":
        ...
        console.print(Panel("[bold green]Vault Statistics[/bold green]\nLanceDB: 0 vectors\nDuckDB: 0 records", expand=False))
