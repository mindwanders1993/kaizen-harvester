...
|:---|:---|:---|:---|
| **1** | `core/schemas.py`, `tests/conftest.py`, `tests/mock_data/` | `pytest tests/test_schemas.py -v` | ⬜ Pending |
| **2** | `core/memory/duckdb_store.py`, `core/memory/lancedb_store.py` | `pytest tests/test_memory.py -v` | ⬜ Pending |
| **3** | `core/agents/scout.py`, `extractor.py`, `curator.py`, `prompts/` | `pytest tests/test_agents.py -v` | ⬜ Pending |
| **4** | `core/ingress/rate_limiter.py`, `github.py`, `web.py` | `pytest tests/test_ingress.py -v` | ⬜ Pending |
